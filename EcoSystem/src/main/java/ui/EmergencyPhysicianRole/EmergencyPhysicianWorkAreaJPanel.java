 ...
 */
package ui.EmergencyPhysicianRole;
 ...
 * @author raunak
 */
public class EmergencyPhysicianWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public EmergencyPhysicianWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, EcoSystem business) {
        initComponents();
    ...
    public void populateTable(){
        ...
        for(WorkRequest request : emergencyOrganization.getWorkQueue().getWorkRequestList()){
