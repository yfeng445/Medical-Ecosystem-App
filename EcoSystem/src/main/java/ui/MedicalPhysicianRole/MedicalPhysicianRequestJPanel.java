 ...
 * @author 
 */
public class MedicalPhysicianRequestJPanel extends javax.swing.JPanel {
    ...
    public MedicalPhysicianRequestJPanel(JPanel userProcessContainer, UserAccount account, 
        ...
        RoleComboBox.addItem("Medical Nurse");
        RoleComboBox.addItem("Surgical Physician");       
    }
    /**
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        MedicalPhysicianWorkAreaJPanel dwjp = (MedicalPhysicianWorkAreaJPanel) component;
            ...
            for (Enterprise ent : network.getEnterpriseDirectory().getEnterpriseList()) {
                if (ent.getName().equals(currentHospital)) {
                    for (Organization org : ent.getOrganizationDirectory().getOrganizationList()) {
                        switch(selectedRole) {
                            case "Medical Nurse":
                                if (org.getOrganizationType().equals(Organization.Type.MedicalOrganization)) {
                                    org.getWorkQueue().getWorkRequestList().add(request);
                                    requestSent = true;
                                }
                                break;                           
                            case "Surgical Physician":                          
